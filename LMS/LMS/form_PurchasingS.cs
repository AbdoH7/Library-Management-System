...
namespace LMS
{
    public partial class form_PurchasingS : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Global.student[j].bought.Add(Global.book[i]);
                    Global.student[j].c_bought++;
                    ...
                    con.Open();
                    Query = @"insert into Student_Bought values('" + j + "','" + Global.book[i].Name + "','" + Global.book[i].Author_name + "','" + Global.book[i].Publication_date + "','" + Global.book[i].Publisher + "','" + Global.book[i].purchase_price + "','" + Global.book[i].state + "','" + Global.book[i].access + "')";
                    ...
                    con.Open();
                    Query = "update Students_Informations set no_Bought='"+Global.student[j].c_bought+"' where Id='"+j+"';";
                    cmd = new SqlCommand(Query, con);
                    cmd.ExecuteReader();
                    con.Close();
